...
## 2024-06-26 - renderQueue Memory Leak
**Learning:** Attaching global document event listeners inside a dynamic list render loop causes exponential memory leaks.
**Action:** Always attach global document listeners once in the outer scope.
