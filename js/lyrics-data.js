    ...
    'pixy-legacy': [
        ...
        },
        {
            ...
            words: [
                ...
                { text: "high,", start: 18.8, duration: 0.3 },
                { text: "jealous", start: 19.1, duration: 0.2 },
                { text: "bitches", start: 19.3, duration: 0.2 }
            ]
        },
        {
            start: 19.5,
            ...
            words: [
                ...
                { text: "me", start: 20.5, duration: 0.5 }
            ]
        },
        {
            start: 21.0,
        ...
        },
        {
            ...
            words: [
                { text: "(Rotten", start: 26.5, duration: 0.4 },
                { text: "in", start: 26.9, duration: 0.2 },
                { text: "they", start: 27.1, duration: 0.2 },
                { text: "eyes,", start: 27.3, duration: 0.4 },
                { text: "wishing", start: 27.7, duration: 0.4 },
                { text: "they", start: 28.1, duration: 0.2 },
                { text: "could", start: 28.3, duration: 0.2 },
                { text: "silence", start: 28.5, duration: 0.3 },
                { text: "me)", start: 28.8, duration: 0.2 }
            ]
        },
        {
            start: 29.5,
            ...
            words: [
                { text: "Swords", start: 29.5, duration: 0.5 },
                { text: "on", start: 30.0, duration: 0.2 },
                { text: "my", start: 30.2, duration: 0.2 },
                { text: "back,", start: 30.4, duration: 0.6 },
                { text: "serpents", start: 31.0, duration: 0.6 },
                { text: "on", start: 31.6, duration: 0.3 },
                { text: "attack", start: 31.9, duration: 0.6 }
            ]
        },
        {
            start: 33.0,
            ...
            words: [
                { text: "Venom", start: 33.0, duration: 0.5 },
                { text: "when", start: 33.5, duration: 0.3 },
                { text: "they", start: 33.8, duration: 0.2 },
                { text: "smile,", start: 34.0, duration: 0.5 },
                { text: "but", start: 34.5, duration: 0.2 },
                { text: "my", start: 34.7, duration: 0.2 },
                { text: "halo", start: 34.9, duration: 0.4 },
                { text: "keep", start: 35.3, duration: 0.3 },
                { text: "me", start: 35.6, duration: 0.2 },
                { text: "strapped", start: 35.8, duration: 0.2 }
            ]
        },
        {
            start: 36.5,
            ...
            words: [
                { text: "(But", start: 36.5, duration: 0.3 },
                { text: "my", start: 36.8, duration: 0.2 },
                { text: "halo", start: 37.0, duration: 0.4 },
                { text: "keep", start: 37.4, duration: 0.3 },
                { text: "me", start: 37.7, duration: 0.2 },
                { text: "strapped)", start: 37.9, duration: 0.6 }
            ]
        },
        {
            start: 39.0,
            ...
            words: [
                ...
                { text: "know", start: 39.4, duration: 0.2 },
                { text: "why", start: 39.6, duration: 0.2 },
                { text: "they", start: 39.8, duration: 0.2 },
                { text: "hate", start: 40.0, duration: 0.4 },
                { text: "on", start: 40.4, duration: 0.2 },
                { text: "me", start: 40.6, duration: 0.4 }
            ]
        },
        {
            start: 41.5,
            ...
            words: [
                ...
                { text: "smell", start: 41.9, duration: 0.4 },
                { text: "the", start: 42.3, duration: 0.2 },
                { text: "legacy", start: 42.5, duration: 0.6 },
                { text: "(Uh-huh)", start: 43.1, duration: 0.9 }
            ]
        },
        {
            start: 44.5,
            ...
            words: [
                ...
                { text: "on", start: 45.2, duration: 0.3 },
                { text: "supremacy", start: 45.5, duration: 1.0 }
            ]
        },
        {
            start: 47.0,
            ...
            words: [
                ...
                { text: "tryna", start: 47.7, duration: 0.4 },
                { text: "come", start: 48.1, duration: 0.3 },
                { text: "for", start: 48.4, duration: 0.2 },
                { text: "me", start: 48.6, duration: 0.4 }
            ]
        },
        {
            start: 50.0,
            ...
            words: [
                { text: "Oh", start: 50.0, duration: 0.3 },
                { text: "you", start: 50.3, duration: 0.2 },
                { text: "wan'", start: 50.5, duration: 0.3 },
                { text: "love", start: 50.8, duration: 0.4 },
                { text: "me", start: 51.2, duration: 0.2 },
                { text: "now?", start: 51.4, duration: 0.6 }
            ]
        },
        {
            start: 52.5,
            ...
            words: [
                { text: "Diamonds", start: 52.5, duration: 0.6 },
                { text: "gon'", start: 53.1, duration: 0.2 },
                { text: "make", start: 53.3, duration: 0.3 },
                { text: "them", start: 53.6, duration: 0.2 },
