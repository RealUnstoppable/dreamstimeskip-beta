...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Attach global drag listeners ONLY ONCE
    ...
    document.addEventListener('pointerup', (e) => {
        ...
        if (isDragging && dragItem) {
            ...
            const idx = parseInt(currentItem.dataset.index, 10);
            ...
            const currentItem = dragItem;
            dragItem = null; // Clear dragItem
            const idx = parseInt(currentItem.dataset.index, 10);
            const songId = currentItem.dataset.songId;
