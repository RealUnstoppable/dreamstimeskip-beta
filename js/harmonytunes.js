...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let dragContextSongId = null;

    // Delegate pointer events to document to avoid memory leaks from adding listeners in renderQueue loop
    ...
    document.addEventListener('pointerup', (e) => {
        ...
        if (isDragging && dragItem) {
            ...
            openQueueContextMenu(e, dragContextSongId, idx);
            dragItem = null;
        }
    });
    ...
    function renderQueue() {
        ...
        // ⚡ Bolt: Batch DOM inserts using DocumentFragment to minimize O(N) reflows
        const fragment = document.createDocumentFragment();
