...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentTapSongId = null;
    let currentTapIdx = null;
    ...
    document.addEventListener('pointerup', (e) => {
        ...
        if (isDragging && dragItem) {
            ...
            dragItem = null;
            if (currentTapSongId !== null && currentTapIdx !== null) {
                openQueueContextMenu(e, currentTapSongId, currentTapIdx);
            }
        } else {
            dragItem = null;
        }
        currentTapSongId = null;
        currentTapIdx = null;
    });
