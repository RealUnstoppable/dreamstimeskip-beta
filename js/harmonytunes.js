...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Extracted global event listeners for drag and drop to prevent memory leaks
    ...
    document.addEventListener('pointerup', (e) => {
        ...
        if (isDragging && dragItem) {
            ...
            // Calculate drop index based on position dynamically avoiding stale closures
            const items = Array.from(queueContentArea.querySelectorAll('.queue-item')).filter(el => el.querySelector('.queue-more-btn'));
    ...
    function renderQueue() {
        ...
        // Use DocumentFragment for batched DOM insertions to prevent layout thrashing
        const fragment = document.createDocumentFragment();
