...
jest.mock('https://www.gstatic.com/firebasejs/11.0.1/firebase-auth.js', () => ({
    onAuthStateChanged: jest.fn()
}));

jest.mock('https://www.gstatic.com/firebasejs/11.0.1/firebase-firestore.js', () => ({
    doc: jest.fn(),
    getDoc: jest.fn()
}));
...
describe('theme-loader.js', () => {
    ...
    beforeEach(() => {
        ...
        const { getDoc } = require('https://www.gstatic.com/firebasejs/11.0.1/firebase-firestore.js');
    ...
    const loadModule = async () => {
        ...
        jest.isolateModules(() => {
            ...
            const { onAuthStateChanged } = require('https://www.gstatic.com/firebasejs/11.0.1/firebase-auth.js');
            onAuthStateChanged.mockImplementation((_, callback) => {
                authStateCallback = callback;
            });
    ...
    it('should set fallback theme when user is authenticated but has no Firestore profile', async () => {
        ...
        const { doc: isolatedDoc, getDoc: isolatedGetDoc } = require('https://www.gstatic.com/firebasejs/11.0.1/firebase-firestore.js');
