...
const firestore = isTest
    ? {
        doc: (...args) => (typeof window !== 'undefined' && window.doc ? window.doc(...args) : {}),
        setDoc: (...args) => (typeof window !== 'undefined' && window.setDoc ? window.setDoc(...args) : Promise.resolve()),
        serverTimestamp: (...args) => (typeof window !== 'undefined' && window.serverTimestamp ? window.serverTimestamp(...args) : {})
      }
