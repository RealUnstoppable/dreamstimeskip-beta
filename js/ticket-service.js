...
export async function createTicket(userId, userEmail, subject, message) {
    ...
    try {
        ...
        console.error('Error creating ticket - Manager info:', error);
        throw error;
    }
}
...
export async function getUserTickets(userId) {
    ...
    try {
        ...
        console.error('Error fetching user tickets - Manager info:', error);
        throw error;
    }
}
...
export async function getAllTickets() {
    try {
        ...
        console.error('Error fetching all tickets - Manager info:', error);
        throw error;
    }
}
...
export async function replyToTicket(ticketId, adminReply, status = 'answered') {
    ...
    try {
        ...
        console.error('Error replying to ticket - Manager info:', error);
        throw error;
    }
}
